...
static void buildMenuTemplate(void)
{
    ...
    ADD(NM_ITEM,  NULL, 0,     0, 0, ACTION_UD(FS3EACTION_NEW_POLL) | MSG_MENU_NEW_POLL);
    BAR(NM_ITEM);
    ADD(NM_ITEM,  NULL, 0, 0, 0, ACTION_UD(FS3EACTION_SHOW_BLOCKED_USERS)   | MSG_MENU_BLOCKED_USERS);
    ADD(NM_ITEM,  NULL, 0, 0, 0, ACTION_UD(FS3EACTION_SHOW_BLOCKED_SERVERS)| MSG_MENU_BLOCKED_SERVERS);
    BAR(NM_ITEM);
    ...
    BAR(NM_ITEM);
    ADD(NM_ITEM,  NULL, 0, 0, 0, ACTION_UD(FS3EACTION_VIEW_ABOUT_SERVER) | MSG_MENU_ABOUT_SERVER);
    ...
    ADD(NM_ITEM,  NULL, 0, 0, 0, ACTION_UD(FS3EACTION_TIMELINE_WHO_FAVED)       | MSG_TIMELINE_WHO_FAVED);
    ADD(NM_ITEM,  NULL, 0, 0, 0, ACTION_UD(FS3EACTION_TIMELINE_WHO_BOOSTED)     | MSG_TIMELINE_WHO_BOOSTED);
